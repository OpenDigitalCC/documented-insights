...
.PHONY: help help-all help-domains help-llm help-pdf help-setup help-utilities

# ============================================================================
# HELP - CONCISE (Common Workflows)
# ============================================================================
...
help:
	...
	@echo "  make report DOMAIN=X    - Generate markdown report (pattern + LLM)"
	@echo "  make report-pdf DOMAIN=X - Generate combined PDF report"
	@echo ""
	@echo "=== COMMON WORKFLOWS ==="
	@echo "  make report-all         - All markdown reports (pattern + LLM)"
	@echo "  make report-pdf-all     - All PDF reports"
	@echo "  make report-full DOMAIN=X - Markdown + PDF for one domain"
	@echo "  make report-full-all    - Complete package (all domains)"
	@echo ""
	@echo "=== DOMAIN SYSTEM ==="
	@echo "  make test-domains       - Validate domain configurations"
	@echo "  make list-domains       - Show available domains"
	@echo "  make query-domain DOMAIN=X - Query responses for domain"
	@echo ""
	@echo "=== ANALYSIS ==="
	@echo "  make search WORD=X      - Search word co-occurrences"
	@echo "  make word-stats         - Word frequency analysis"
	@echo ""
	@echo "=== LLM EXTRACTION ==="
	@echo "  make llm-schema         - Install LLM database schema (one-time)"
	@echo "  make llm-extract DOMAIN=X - Extract positions for domain"
	@echo "  make llm-extract-all-bg - Background extraction (all domains)"
	...
	@echo "  make help-all     - Complete reference"
	@echo "  make help-domains - Domain configuration"
	@echo "  make help-llm     - LLM extraction"
	@echo "  make help-pdf     - PDF generation"

# ============================================================================
# HELP - EXTENDED (All Commands)
# ============================================================================

help-all: help help-pdf help-domains help-llm help-setup help-utilities
...
help-setup:
	...
	@echo "  make load               - Load JSON data into PostgreSQL"
	@echo ""
	@echo "Attachments (Optional):"
	@echo "  make download-attachments - Download PDFs/DOCX from EC"
	@echo "  make extract            - Extract text from attachments"
	@echo "  make retry-extractions  - Retry failed extractions"
	@echo "  make redownload-corrupt - Re-download corrupt files"
	@echo ""
	@echo "Indexing:"
	...
	@echo "  make overnight          - Full pipeline (extract + index)"
...
help-pdf:
	...
	@echo ""
	@echo "Single Domain:"
	@echo "  make report-pdf DOMAIN=X - Generate combined PDF (pattern + LLM)"
	@echo "  make report-full DOMAIN=X - Markdown + PDF together"
	@echo ""
	@echo "All Domains:"
	@echo "  make report-pdf-all     - Generate all PDFs"
	@echo "  make report-full-all    - Markdown + PDF for all domains"
	@echo ""
	@echo "Testing & Cleanup:"
	@echo "  make test-pandoc        - Verify Pandoc/LaTeX installation"
	@echo "  make clean-pdf          - Remove generated PDFs"
	@echo "  make clean-combined     - Remove temporary combined files"
	@echo ""
	@echo "Requirements:"
	@echo "  - Pandoc with XeLaTeX"
	@echo "  - LaTeX packages (booktabs, longtable, etc.)"
	@echo "  - UTF-8 text encoding"
	@echo ""
	@echo "Output:"
	@echo "  output/pdf/domain_DOMAIN_analysis.pdf"
...
help-domains:
	...
	@echo "  make validate-domains   - Validate configuration syntax"
	...
	@echo "  make report-all         - Generate all domain reports"
	@echo ""
	@echo "Pattern Analysis Only:"
	@echo "  make report-all-pattern - Pattern reports only (fast)"
	@echo ""
	@echo "LLM Reports Only:"
	@echo "  make report-all-llm     - LLM reports only"
	@echo ""
	...
	@echo ""
	@echo "Adding New Domains:"
	@echo "  1. Create domains/your-domain.conf"
	@echo "  2. Add keywords, keyphrases, related_words"
	@echo "  3. make test-domains"
	@echo "  4. make query-domain DOMAIN=your-domain"
	@echo "  5. make report DOMAIN=your-domain"
...
help-llm:
	...
	@echo "  make llm-retry-all-failed - Retry all failures across domains"
	@echo ""
	@echo "Status & Review:"
	@echo "  make llm-status         - Overall extraction progress"
	@echo "  make llm-summary        - Processing summary by domain"
	@echo "  make llm-progress       - Detailed progress by domain"
	...
	@echo "  make llm-reports-all    - Generate all LLM reports"
	@echo ""
	@echo "Maintenance:"
	...
	@echo ""
	@echo "Performance:"
	@echo "  CPU: 2-3 minutes per response (3-5 days for all)"
	@echo "  GPU: 5-15 seconds per response (3-6 hours for all)"
	@echo "  Use OLLAMA_HOST in .env for remote GPU"
...
help-utilities:
	...
	@echo "  make clean              - Remove old output files"
	@echo "  make clean-pdf          - Remove generated PDFs"
	@echo "  make clean-combined     - Remove temporary files"
	@echo ""
	@echo "Logs:"
	@echo "  make logs               - View recent container logs"
	@echo "  docker logs -f documented-insights-perl"
	@echo "  docker logs -f documented-insights-embeddings"
	@echo ""
	@echo "Testing:"
	@echo "  make test-domains       - Validate domain configs"
	@echo "  make test-pandoc        - Verify PDF generation tools"
	@echo "  bash scripts/test_system_end_to_end.sh - Full validation"
